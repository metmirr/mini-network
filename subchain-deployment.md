...
curl -X POST --data '{
    ...
    "params": {
        "controlKeys":[
            "P-custom17zl5lw6l4uj58aauveh4q7scyhsf9kuz02pwua",
...
curl -X POST --data '{
    ...
    "params": {
        ...
        "subnetID":"GbJAvRW5oXHLy1tonqzeEuZA9hwd7Tf2aejx7onNy4Q1WW5MB",
        "startTime":1675105595,
        "endTime":1677601839,
        "weight":30,
        "changeAddr": "P-custom154xg4yd90t5gs72szaz469lwgsv9pgv264l0kd",
        "username":"metin",
...
Restart the validator node to validate the blockchain.
...
curl -X POST --data '{
    ...
    "params": {"subnetID":"GbJAvRW5oXHLy1tonqzeEuZA9hwd7Tf2aejx7onNy4Q1WW5MB"},
    "id": 1
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/P
```
...
curl -X POST --data '{
    ...
    "params" :{
        "blockchainID":"2oTJimtQGCcSu6Gv88B5PbJp6b5EWM3VBE9xM38Ce7swxeXdFE"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/P
```
